...
Route::get('/trx/page', 'App\Http\Controllers\TransactionController@index');
//get form input
Route::get('/trx/form/input', 'App\Http\Controllers\TransactionController@input');
//get form edit
Route::get('/trx/form/edit/{id}', 'App\Http\Controllers\TransactionController@edit');
//post method to save data
Route::post('/trx/add', 'App\Http\Controllers\TransactionController@add');
//put method to update data
Route::post('/trx/update', 'App\Http\Controllers\TransactionController@update');
//delete data
Route::get('/trx/delete/{id}', 'App\Http\Controllers\TransactionController@delete');
//get data category_type_id
Route::get('/trx/category_type', 'App\Http\Controllers\TransactionController@category_type');
