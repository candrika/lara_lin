...
<script type="text/javascript">
    $(function() {
        ...
        $('#add_income_cat').on('click',function(e){
        	...
        	$.get('/income/form/input').done(function(response){
        ...
        $('#hapus_<?=$title_content?>').click(function(e){
        	...
        	if(confirm("Apa anda yakin?")){
        		$.get('/income/delete/'+$(this).data('hapus-id')).done(function(response){
        ...
        $('#edit_<?=$title_content?>').click(function(e){
        	...
        	e.preventDefault(e);
        	$('.preloader-backdrop').show();
        	$.get('/income/form/edit/'+$(this).data('edit-id')).done(function(response){
        		console.log(response)
        		$('.preloader-backdrop').hide();
                $('.content-wrapper').html(" ");
                $('.content-wrapper').html(response);
